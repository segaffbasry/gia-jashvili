    ...
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          color: langOpen ? "#877a72" : "rgba(255,255,255,0.75)",
          padding: "4px 6px", transition: "color 0.2s",
        }}
        onMouseEnter={(e) => (e.currentTarget.style.color = "#877a72")}
      ...
      >
        {/* top accent line */}
        <div style={{ height: "1px", background: "linear-gradient(to right, transparent, #877a72, transparent)" }} />
        {LOCALES.map(({ code, label }, i) => (
          <button
            ...
            style={{
              ...
              color: code === locale ? "#877a72" : "rgba(255,255,255,0.6)",
            ...
            onMouseLeave={(e) => { e.currentTarget.style.color = code === locale ? "#877a72" : "rgba(255,255,255,0.6)"; e.currentTarget.style.paddingLeft = "1rem"; }}
          >
            {code === locale && <span style={{ width: "3px", height: "3px", borderRadius: "50%", background: "#877a72", flexShrink: 0 }} />}
            {label}
          </button>
        ))}
      </div>
      ...
      >
        {label.split("").map((ch, i) => (
          <span key={i} style={{ display: "inline-block", overflow: "hidden", position: "relative", verticalAlign: "top", ...FONT }}>
            ...
            <span className="nl-h" style={{ position: "absolute", inset: 0, color: "#877a72", fontStyle: "italic" }}>{ch}</span>
          </span>
        ))}
      </a>
      <span
